...
func suggestSessionID(ctx context.Context, store *session.Store, input string) (string, error) { //nolint:unused // kept for backward compatibility with older command structures
